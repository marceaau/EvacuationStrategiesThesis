...
to setup
  ...
  import-pcolors "validity_map_1.jpg"
...
to calculate-path
 ...
 [
  ...
  set calculated-path A* Start destination patches with [pcolor = white or pcolor = blue]
...
@#$#@#$#@
<experiments>
  <experiment name="socialforce" repetitions="50" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>ticks</metric>
